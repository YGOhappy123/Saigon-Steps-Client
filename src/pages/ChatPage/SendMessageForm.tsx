...
const SendMessageForm = ({ onOptimisticDisplay }: SendMessageFormProps) => {
    ...
    const sendMessageMutation = useMutation({
        mutationFn: (data: Partial<IChatMessage> & { tempId: number }) =>
            axios.post<IResponseData<any>>('/chats', data),
        onError: onError
    })
