...
import OrderTableToolbar from '@/pages/OrderManagementPage/OrderTableToolbar'
...
const OrderTable = ({
    ...
    const columns: ColumnDef<IOrder>[] = [
        ...
        },
        {
            ...
            header: () => <div>Ngày đặt hàng</div>,
            cell: ({ row }) => <p>{dayjs(row.original.createdAt).format('DD/MM/YYYY HH:mm:ss')}</p>
        },
        {
            id: 'lastUpdate',
                        ...
                        <DropdownMenuContent align="center" className="w-[160px]">
                            ...
                            <DropdownMenuItem className="cursor-pointer">
                                <PDFDownloadLink
                                    ...
                                    document={<InvoicePDF order={row.original} user={customerInfo} />}
